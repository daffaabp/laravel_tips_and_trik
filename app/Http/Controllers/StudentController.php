...
class StudentController extends Controller
{
    ...
    public function show($id) {
        $student = Student::with(['class.homeroomTeacher', 'extracurriculars'])->findOrFail($id); // method findOrFail berfungsi untuk jika ada akan ia tampilkan datanya, tapi jika tidak ada dia akan menampilkan Not Found
